...
public class WebviewSetingUtils {
    ...
    public void initSetting(Context context, CustomWebView webView, boolean isLog, boolean picIsClick, String webViewCacheMode) {
...
//      String cacheDirPath = getCacheDir().getAbsolutePath()+Constant.APP_DB_DIRNAME;
        ...
        Log.e("webview", "webview cache model is " + webViewCacheMode);
        if (webViewCacheMode != null && webViewCacheMode.length() > 0) {
            if (webViewCacheMode.equals("LOAD_CACHE_ONLY")) {
                webSettings.setCacheMode(WebSettings.LOAD_CACHE_ONLY);
            } else if (webViewCacheMode.equals("LOAD_DEFAULT")) {
                webSettings.setCacheMode(WebSettings.LOAD_DEFAULT);
            } else if (webViewCacheMode.equals("LOAD_NO_CACHE")) {
